...
export function ReminderNotificationStatus() {
  ...
  return <View style={styles.card}>
    ...
    <Text style={styles.body}>{permission === 'granted' ? 'Notification permission is enabled.'
    ...
    {runtime.result && <Text style={styles.body}>{runtime.result.scheduled} upcoming notifications scheduled.
    ...
    {runtime.error && <Text accessibilityRole="alert" style={styles.body}>{runtime.error}</Text>}
