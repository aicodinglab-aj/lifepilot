...
export function EmptyState({ icon, title, description, action }: {
  icon?: ReactNode; title: string; description: string; action?: { label: string; onPress: () => void };
}) {
  ...
  return <View style={{ alignItems: 'center', paddingHorizontal: spacing.lg, paddingVertical: spacing.xl, gap: spacing.md }}>
    ...
    {action && <Button label={action.label} onPress={action.onPress} style={{ marginTop: spacing.xs }} />}
  </View>;
}
